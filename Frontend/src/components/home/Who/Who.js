...
//         allowTouchMove={false}
//       >
//         {data?.map(({ banarMedia, banarMediaMobile }, i) => (
//           <SwiperSlide key={i}>
//             {banarMedia?.data.attributes.mime.startsWith("image") ? (
//               <>
//                 <img
//                   className={styles.imageDesktop}
//                   src={`http://localhost:1337${banarMedia.data.attributes.url}`}
//                   alt="no image"
//                 />
//                 <img
//                   className={styles.imageMob}
//                   src={`http://localhost:1337${banarMediaMobile.data.attributes.url}`}
//                   alt="no image"
//                 />
//               </>
//             ) : (
